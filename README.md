...
hide access to variables/data that are inside the class
simpler modeling of real world scenarios
...
efficiency, lazy evaluation, nested functions, parallel programming
